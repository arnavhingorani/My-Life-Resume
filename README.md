...
- Add photos, descriptions, and tags to memories
...
This repository is the main section of the code built for the app, without all the files and platform folders built into Flutter projects. To run this project locally, these would need to be regenerated.

Developed by Arnav Hingorani.
